...
opinions.rating = round(opinions.rating.map(lambda x: float(x.split("/")[0].replace(",","."))), 2)

#podstawowe statystyki opinii:
#opinions_count = opinions.opinion_id.count() ROZNE MOZLIWOSCI POLICZENIA WIERSZY
